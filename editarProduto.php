...
<?php
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $idProduto = filtrar_entrada($_POST['idProduto']); //Recebe por POST o ID do produto a ser alterado
        $statusProduto = filtrar_entrada($_POST['statusProduto']); //Recebe por POST o status do Produto
        ...
        if ($_FILES["fotoProduto"]["size"] != 0){ //Usa a propriedade "size" para verificar o tamanho 
            ...
            //Caso não haja foto passada por POST, mantém a foto atual
        ...
        if(!$erroPreenchimento && !$erroUpload){
            ...
            //Cria a Query para realizar a atualização das informações na tabela Produtos
            $editarProduto = "UPDATE Produtos
                              SET
                                ...
                                horaCadastroProduto = '$horaCadastroProduto',
            ...
            if(mysqli_query($conn, $editarProduto)){
                ...
                echo "
                    <div class='alert alert-success text-center'>Produto editado com sucesso!</div>
                ...
                echo "<div class='alert alert-danger text-center'>Erro ao tentar editar produto!</div>" . mysqli_error($conn);
                echo "<p>$editarProduto</p>";
            }
        }
